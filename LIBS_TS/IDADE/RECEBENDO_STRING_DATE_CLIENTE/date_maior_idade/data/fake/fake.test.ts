...
import { fakeMaiorIdade, fakeMaiorOrMenorIdade } from "./fake.ts";
...
Deno.test("deve retornar o correspondente ao objeto fakeMaiorOrMenorIdade", () => {
  ...
  expect(fakeMaiorOrMenorIdade.dataSimuladaMaiorQue18OK).toBe("18/05/2005");
  expect(fakeMaiorOrMenorIdade.dataSimuladaMenorQue18FAIL).toBe("19/05/2005");
});
